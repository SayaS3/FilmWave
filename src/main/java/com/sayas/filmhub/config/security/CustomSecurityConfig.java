    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http.
                authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(mvc.pattern("/add-comment")).authenticated()
                        .requestMatchers(mvc.pattern("/submit-movie")).hasAnyRole(EDITOR_ROLE, ADMIN_ROLE)
                        .requestMatchers(mvc.pattern("/report-error")).authenticated()
